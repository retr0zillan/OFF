...
class EngineData {
      ...
      arguments: [
        {
          ...
          type: EventArgType.Dropdown,
          defaultVal: "blackIn",
          dropdownValues: ["blackIn", "blackOut"]
        }
      ]
    },
  ];
  public static var noteTypes:Array<String> = ["default","alt","mine", "bat"];
  ...
  public static var weekData:Array<WeekData> = [
    ...
    new WeekData("Tutorial",0,'dad',[
      "Judgement"
    ]),
    new WeekData("DADDY DEAREST",1,'dad',[
      "Spectral-Curveball"
    ]),
    new WeekData("DADDY DEAREST",2,'dad',[
      "Iron-Fist"
    ]),
    new WeekData("DADDY DEAREST",3,'dad',[
      "Hellish-Hiems"
    ]),
    new WeekData("DADDY DEAREST",4,'dad',[
      "A-Furia-do-Colosso"
    ]),
    new WeekData("DADDY DEAREST",5,'dad',[
      "Melancholy-Symphony"
    ]),
    new WeekData("DADDY DEAREST",6,'dad',[
      "Hugo"
    ]),
    new WeekData("DADDY DEAREST",7,'dad',[
      "Ascendants-Echo"
    ]),

    new WeekData("DADDY DEAREST",8,'dad',[
      "No-Way-Back"
    ]),
    new WeekData("DADDY DEAREST",9,'dad',[
      "Bis-Vincit"
    ]),
    new WeekData("DADDY DEAREST",10,'dad',[
      "Blue-Tulip"
    ]),
  ];
